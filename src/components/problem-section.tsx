        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeIn>
            <div className="space-y-8">
              ...
              <p className="text-lg text-text-body/70 leading-relaxed">
                After 25 years helping Canadian families plan for retirement,
                these are the questions I hear most:
              </p>
          ...
          <FadeIn delay={200}>
            <div className="relative">
              ...
              {/* Decorative element */}
              <div className="absolute -z-10 -top-4 -right-4 w-full h-full rounded-3xl bg-gradient-to-br from-light-purple to-brand-purple/10" />
            </div>
          </FadeIn>
        </div>
      </div>
