    ...
    <section id="about" className="py-20 md:py-28 bg-light-purple/30">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Photo column */}
          <FadeIn className="relative flex justify-center lg:justify-start">
            <div className="relative">
              ...
              {/* Decorative element */}
              <div className="absolute -z-10 -bottom-4 -left-4 w-full h-full rounded-3xl bg-gradient-to-br from-brand-purple/15 to-sky-blue/15" />
            </div>
          </FadeIn>
